...
// ET: This is a Konstructor! Yay!
Cube::Cube() {

	m_numFaces = 6 * 2;

	// ET: VAO = Vertex Array Object; saves how Data in VBO is interpreted
	// ET: Purpose example: You don't have to say "these 3 numbers make one corner" every time
	...
	// ET: VBOs = Vertex Buffer Objects; saves vertex data, so that Graficcard knows where Corners are
